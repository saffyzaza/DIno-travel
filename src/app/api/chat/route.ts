...
2.  **การแนะนำสถานที่ (หน้าที่หลัก):**
    ...
    *   สร้างคำตอบตามรูปแบบที่กำหนดด้านล่าง โดยใช้ข้อมูลจาก [id], [title], [location], [urllocation], และ [activities]
...
*   **ลิงก์อ่านเพิ่มเติม:** ใส่คำเชิญชวน เช่น "อ่านรายละเอียดเพิ่มเติม" แล้วตามด้วยลิงก์ในรูปแบบ HTML: <a href="/destinations/[id]" target="_self">อ่านเพิ่มเติม</a>
...
<a href="/destinations/1" target="_self">อ่านเพิ่มเติม</a>
---
`;
